...
This demonstrates how I automated <strong>user onboarding, offboarding, access reviews, and MFA enforcement</strong> in Azure Active Directory using <strong>PowerShell + Microsoft Graph</strong>.  
...
<p align="center">
🖼️ Azure Active Directory Overview Page  
</p>
